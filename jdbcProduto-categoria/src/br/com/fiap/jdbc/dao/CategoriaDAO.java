...
public class CategoriaDAO {
	...
	public List<Categoria> ListarComProduto(){
		 try {
			...
			List<Categoria> categorias = new ArrayList<Categoria>();
			String sql = "SELECT C.idCategoria, C.nome, P.idProtudo, P.Nome, P.descricao, P.preco, P.idCategoria" + "FROM CATEGORIA C INNER JOIN PRODUTO P ON C.idCategoria = P.idCategoria order by C.idCategoria";
			PreparedStatement stmt = connection.prepareStatement(sql);
			stmt.execute();
